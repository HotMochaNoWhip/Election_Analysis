...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        county_percentage = round(float(votes_county) / float(total_votes) * 100, 1)
        ...
        if (votes_county > win_county_votes) and (county_percentage > win_county_percentage):
            win_county_votes = votes_county
